...
export default function DemoFinkePage() {
  const lead = MOCK_LEADS.find(l => l.id === 'lead-3')!
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-4">
      <div className="flex items-center gap-3">
        ...
        <Link href="/demo/lead/dataflow" className="text-sm text-slate-500 hover:text-slate-800">DataFlow Consulting →</Link>
      </div>
